...
\subsubsection{Principles of Sputtering}
...
The sample can now be carefully placed inside the chamber centering it under the amorphous germanium target as seen in Figure ~\ref{}
\begin{figure}[htpb]
\centering
\includegraphics[width=0.5\textwidth]{sput-open.JPG}
