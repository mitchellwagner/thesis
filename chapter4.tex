...
\section{Final Steps}
While aluminum is great for the contacts, it can cause the detector to breakdown if any is left on the sides.
Thus after aluminum deposition, the sides must be etched
\begin{figure}[htpb]
\centering
\includegraphics[width=0.4\textwidth]{taped}
